...
let info = `◪ 📮 *SCRIPT BOT NO ENC*
*Beli lah ngab ya kalik free🗿*
`.trim()
await conn.send2Button(m.chat, info, `${botol}`, '⋮☰ MENU', '.menu', 'PROFILE', '.profile', ftrol)
}
handler.help = ['sc']
handler.tags = ['tutor']
handler.command = /^(scnoenc)$/i
handler.owner = false
handler.mods = false
