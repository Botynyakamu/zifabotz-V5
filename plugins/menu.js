...
▌│█║▌║▌║║▌║▌║█│▌ `.trim(),
                        "footerText": "group off bot https://bit.ly/3IKkoym",
...
"title": "|👾|─────「 30 」",
    ...
    await conn.send2ButtonLoc(m.chat, await (await fetch(thumbfoto)).buffer(), text.trim(), watermark, 'Pemilik Bot', `${_p}owner`, 'Tutorial cara buat bot', `.carabuatbot`, m)
  } catch (e) {
